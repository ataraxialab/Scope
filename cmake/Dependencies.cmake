...
shadow_find_os_arch(Tron_Platform Tron_Arch)
...
set(CMAKE_INSTALL_RPATH ${CMAKE_INSTALL_PREFIX}/${Tron_INSTALL_LIB_PREFIX})
...
if (NOT ${USE_CUDA})
  ...
  if (${USE_BLAS})
    if (${BLAS} STREQUAL "OpenBLAS" OR ${BLAS} STREQUAL "openblas")
      ...
      if (OpenBLAS_FOUND)
        ...
        list(APPEND Tron_LINKER_LIBS ${OpenBLAS_LIBRARIES})
    ...
    elseif (${BLAS} STREQUAL "MKL" OR ${BLAS} STREQUAL "mkl")
      ...
      if (MKL_FOUND)
        ...
        list(APPEND Tron_LINKER_LIBS ${MKL_LIBRARIES})
  ...
  if (${USE_NNPACK})
    ...
    if (NNPACK_FOUND)
      ...
      list(APPEND Tron_LINKER_LIBS ${NNPACK_LIBRARIES})
...
if (${USE_CURL})
  ...
  if (${CURL_FOUND})
    ...
    list(APPEND Tron_LINKER_LIBS ${CURL_LIBRARIES})
